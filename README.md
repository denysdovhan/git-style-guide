...
* Комітьте *своєчасно* та *часто*. Маленькі, атомарні коміти легше зрозуміти
  та скасувати, якщо щось піде не так як слід.
...
* Для написання повідомлень використовуйте текстовий редактор замість
  терміналу:
...
* Якщо *коміт A* залежить від іншого *коміту Б*, то цю залежність слід вказати
  ...
  Аналогічно, якщо *Коміт A* вирішує проблему допущену в *коміті Б*, це слід
...
* Зберігайте історію *чистою* та *простою*. *Перед злиттям* вашої гілки:
    ...
    1. Переконайтесь, що зміни відповідають цьому керівництву, якщо вони не
       ...
       переформулюйте їх повідомленя та інше.)
...
* Тримайте ваш локальний *та* віддалений репозиторій в хорошому стані за
  допомогою команд:
